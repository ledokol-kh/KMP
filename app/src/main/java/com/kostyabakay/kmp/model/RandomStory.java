 ...
 * Экземпляр класса RandomStory представляет один пост в разделе "Случайная"
 */
public class RandomStory {
    ...
    public RandomStory(String storyId, String storyUrl, String storyDateAndTime, String storyTag, String storyContent, String storyVote) {
